...
! grep '^server.http.advertised_address' /etc/neo4j/neo4j.conf && sudo echo "server.http.advertised_address=vm4:7474" >> /etc/neo4j/neo4j.conf
cat /etc/neo4j/neo4j.conf | grep server.http.advertised_address

cat /etc/neo4j/neo4j.conf | grep server.bolt.advertised_address
sudo sh -c '! grep "^server.bolt.advertised_address" /etc/neo4j/neo4j.conf && echo "server.bolt.advertised_address=vm4:7687" >> /etc/neo4j/neo4j.conf'
cat /etc/neo4j/neo4j.conf | grep server.bolt.advertised_address

cat /etc/neo4j/neo4j.conf | grep server.cluster.advertised_address
sudo sh -c '! grep "^server.cluster.advertised_address" /etc/neo4j/neo4j.conf && echo "server.cluster.advertised_address=vm4:6000" >> /etc/neo4j/neo4j.conf'
cat /etc/neo4j/neo4j.conf | grep server.cluster.advertised_address

cat /etc/neo4j/neo4j.conf | grep server.cluster.raft.advertised_address
sudo sh -c '! grep "^server.cluster.raft.advertised_address" /etc/neo4j/neo4j.conf && echo "server.cluster.raft.advertised_address=vm4:7000" >> /etc/neo4j/neo4j.conf'
cat /etc/neo4j/neo4j.conf | grep server.cluster.raft.advertised_address

cat /etc/neo4j/neo4j.conf | grep server.discovery.advertised_address
sudo sh -c '! grep "^server.discovery.advertised_address" /etc/neo4j/neo4j.conf && echo "server.discovery.advertised_address=vm4:5000" >> /etc/neo4j/neo4j.conf'
cat /etc/neo4j/neo4j.conf | grep server.discovery.advertised_address

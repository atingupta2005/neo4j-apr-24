...
! grep '^server.http.advertised_address' /etc/neo4j/neo4j.conf && echo "server.http.advertised_address=vm2:7474" >> /etc/neo4j/neo4j.conf

cat /etc/neo4j/neo4j.conf | grep server.bolt.advertised_address
! grep '^server.bolt.advertised_address' /etc/neo4j/neo4j.conf && echo "server.bolt.advertised_address=vm2:7687" >> /etc/neo4j/neo4j.conf


cat /etc/neo4j/neo4j.conf | grep server.cluster.advertised_address
! grep '^server.cluster.advertised_address' /etc/neo4j/neo4j.conf && echo "server.cluster.advertised_address=vm2:6000" >> /etc/neo4j/neo4j.conf

cat /etc/neo4j/neo4j.conf | grep server.cluster.raft.advertised_address
! grep '^server.cluster.raft.advertised_address' /etc/neo4j/neo4j.conf && echo "server.cluster.raft.advertised_address=vm2:7000" >> /etc/neo4j/neo4j.conf

cat /etc/neo4j/neo4j.conf | grep server.discovery.advertised_address
! grep '^server.discovery.advertised_address' /etc/neo4j/neo4j.conf && echo "server.discovery.advertised_address=vm2:5000" >> /etc/neo4j/neo4j.conf
